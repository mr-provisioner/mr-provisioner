from flask import Blueprint, abort, request, send_from_directory, safe_join
...
MAC_FILE_REGEX = r"/01-([\da-fA-F]{2}-[\da-fA-F]{2}-[\da-fA-F]{2}-[\da-fA-F]{2}-[\da-fA-F]{2}-[\da-fA-F]{2})"
